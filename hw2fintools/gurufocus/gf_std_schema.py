...
def annual_10K_hist_s5v1(fin_file_path, param_file_path):
    ...
    if 'income_statement.Net Interest Income (for Banks)' in fin_df0:
        final_df = fin_df1
        ...
        ## Supplemental
        fin_df1['SharesOutstandingEOP'] = pd.to_numeric(
            fin_df0['valuation_and_quality.Shares Outstanding (EOP)'],errors='coerce')
